...
export default function CreateManagerServicePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await createService.mutateAsync(dataToSend);
    ...
    <div className='max-w-2xl mx-auto space-y-6'>
      ...
      <div className='flex items-center gap-4'>
        ...
        <div>
          ...
          <p className='text-muted-foreground mt-1'>Adicione um novo serviço ao seu catálogo</p>
        </div>
      </div>
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className='space-y-6'>
            ...
            <div className='flex gap-4 pt-4 border-t'>
              <Link href='/manager-dashboard/services' className='flex-1'>
