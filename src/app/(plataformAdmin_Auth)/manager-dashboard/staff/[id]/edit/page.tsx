...
export default function EditManagerStaffPage({ params }: { params: { id: string } }) {
  ...
  // Verificar se o staff pertence ao tenant do manager
  if (ownerInfo && staff.tenantId !== ownerInfo.tenantId) {
    return (
      <div className='max-w-2xl mx-auto space-y-6'>
        <Card>
          <CardContent className='pt-6'>
            <div className='flex flex-col items-center text-center gap-4'>
              ...
              <div>
                ...
                <p className='text-muted-foreground text-sm mt-1'>
                  Este funcionário não pertence à sua organização.
                </p>
              </div>
              <Link href='/manager-dashboard/staff'>
                <Button>Voltar para Funcionários</Button>
