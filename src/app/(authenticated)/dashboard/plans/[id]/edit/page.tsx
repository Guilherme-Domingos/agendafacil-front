...
export default function EditPlanPage() {
  ...
  // Preenche o formulário quando os dados do plano são carregados
  useEffect(() => {
    if (plan) {
      setFormData({
        name: plan.name,
      ...
      // Converte o objeto features em array
    ...
    return (
      <div className="container mx-auto py-8 px-4">
        <Card className="border-red-200">
          <CardHeader>
            <CardTitle className="text-red-600">Plano não encontrado</CardTitle>
            <CardDescription>
    ...
    <div className="container mx-auto py-8 px-4 max-w-4xl">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Edite os detalhes e funcionalidades do plano
          </CardDescription>
        </CardHeader>
        <CardContent>
